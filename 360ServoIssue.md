...
PWM分解能4096(1周期20ms)とした場合PWM設定値とサーボ回転数の関係は下記の通り。調整範囲0.7~2.3msのうち実際に回転数調整に使える調整範囲はごく一部。  
...
上記データは複数のFS90Rの平均値で、実際には個々のFS90RでPWM設定値が±10step程度ずれる。FS90Rごとに調整しないと正しく回転数50%のPWMを設定することができない。
