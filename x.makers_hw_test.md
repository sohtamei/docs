...
一方で「メイカーフェア東京」など、もの作りをする製作者のことを通常「メーカー」でなく「メイカー」と呼びますが、これえはクリスアンダーソンの著書「MAKERS」によりMAKERという単語が日本で広まった際、和製英語の「メーカー」と区別するため「メイカー」になったものと思われます。どちらも英語では「maker」になります。
